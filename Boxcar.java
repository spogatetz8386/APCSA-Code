...
public class Boxcar
{
    ...
    private String repairString = "in service";
    ...
    public String toString()
    {
        ...
        return this.numUnits + " " + this.cargo + "\t" + this.repairString;
    }
    ...
    public void setCargo(String c)
    {
        ...
        if(input.equals("gadgets") || input.equals("widgets") || input.equals("wadgets")){
             this.cargo = input;
        } else {
             this.cargo = "gizmos";
        }
